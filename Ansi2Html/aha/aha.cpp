...
#define AHA_VERSION "0.4.6.1-vs2012"
#include <stdlib.h>
#include <stdio.h>
#include <string.h>
...
int main(int argc, char* argv[])
{
    ...
    {
        if ((strcmp(argv[p],(char*)"--help")==0) || (strcmp(argv[p],(char*)"-h")==0) || (strcmp(argv[p],(char*)"-?")==0))
        {
            printf("Ansi Html Adapter Version "AHA_VERSION"\n");
            printf("aha takes SGR-colored Input and prints W3C conform HTML-Code\n");
            printf("use: aha <options> [-f file]\n");
            printf(" aha (--help|-h|-?)\n");
            printf("aha reads the Input from a file or stdin and writes HTML-Code to stdout\n");
            printf("options: --black, -b: Black Background and White \"standard color\"\n");
            printf(" --pink, -p: Pink Background\n");
            ...
            printf(" echo q | htop | aha -l > htop.htm\n");
            ...
            printf("Example: aha --help | aha --black > aha-help.htm\n");
            printf(" Writes this help text to the file aha-help.htm\n\n");
            printf("Copyleft Alexander Matthes aka Ziz 2012\n");
            printf(" zizsdl@googlemail.com\n");
            printf(" http://ziz.delphigl.com/tool_aha.php\n");
            printf("This application is subject to the MPL or LGPL.\n");
            return 0;
        }
        else
            if ((strcmp(argv[p],(char*)"--version")==0) || (strcmp(argv[p],(char*)"-v")==0))
            {
                printf("Ansi Html Adapter Version "AHA_VERSION"\n");
                return 0;
            }
            else
                if ((strcmp(argv[p],"--title")==0) || (strcmp(argv[p],"-t")==0))
                {
                    if (p+1>=argc)
                    {
                    ...
                    if ((strcmp(argv[p],"--line-fix")==0) || (strcmp(argv[p],"-l")==0))
                    {
                        htop_fix=1;
                    }
                    else
                        if ((strcmp(argv[p],"--no-header")==0) || (strcmp(argv[p],"-n")==0))
                        {
                            no_header=1;
                        }
                        else
                            if ((strcmp(argv[p],"--word-wrap")==0) || (strcmp(argv[p],"-w")==0))
                                word_wrap=1;
                            else
                                if ((strcmp(argv[p],"--black")==0) || (strcmp(argv[p],"-b")==0))
                                    colorshema=1;
                                else
                                    if ((strcmp(argv[p],"--pink")==0) || (strcmp(argv[p],"-p")==0))
                                        colorshema=2;
                                    else
                                        if ((strcmp(argv[p],"--iso")==0) || (strcmp(argv[p],"-i")==0))
                                        {
                                            if (p+1>=argc)
                                            {
